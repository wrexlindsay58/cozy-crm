...
export const leads: Lead[] = [
  ...
  { id: "L-4796", name: "Rita Colson", phone: "(602) 555-0160", email: "rita.colson@gmail.com", address: "3122 E Camelback Rd", city: "Phoenix, AZ", source: "Canvass", status: "Cancelled", tone: "muted", setter: "Priya Shah", closer: "Nate Solis", office: "Phoenix", created: "Sep 6", next: "—", product: "Windows", value: 21400, notes: "Cancelled 2 hours before run. Reschedule later." },
  ...
  { id: "L-4781", name: "Harold Price", phone: "(623) 555-0129", email: "hprice52@aol.com", address: "16840 W Greenway Rd", city: "Surprise, AZ", source: "Canvass", status: "Not qualified", tone: "muted", setter: "Priya Shah", closer: "Marco Velez", office: "Phoenix", created: "Sep 3", next: "—", product: "Attic R-49", value: 0, notes: "Renter. Landlord will not approve." },
  ...
  { id: "L-4711", name: "Carol Jensen", phone: "(602) 555-0136", email: "cjensen@gmail.com", address: "510 W Encanto Blvd", city: "Phoenix, AZ", source: "Google", status: "Abandoned", tone: "muted", setter: "Amber Quinn", closer: "Nate Solis", office: "Phoenix", created: "Aug 18", next: "—", product: "Air scrubber", value: 2800, notes: "Stopped answering after quote." },
];
...
export const appointments: Appointment[] = [
  ...
  { id: "AP-84", leadId: "L-4761", name: "Whitaker install", day: 18, time: "7:30a", status: "Install", tone: "up", setter: "—", closer: "Dana Ortiz", product: "Envelope package", city: "Scottsdale" },
  ...
  { id: "AP-80", leadId: "L-4788", name: "Cho install", day: 22, time: "7:00a", status: "Install", tone: "up", setter: "—", closer: "Dana Ortiz", product: "Attic + HVAC", city: "Scottsdale" },
  { id: "AP-78", leadId: "L-4733", name: "Rahman install", day: 24, time: "8:00a", status: "Install", tone: "up", setter: "—", closer: "Luis Haddad", product: "Attic + Aeroseal", city: "Dallas" },
  ...
  { id: "AP-76", leadId: "L-4774", name: "Nina Patel", day: 13, time: "4:00p", status: "At risk", tone: "alert", setter: "Amber Quinn", closer: "Luis Haddad", product: "Air sealing", city: "Dallas" },
...
export const tickets: Ticket[] = [
  ...
  { id: "T-66", title: "Closed — Alvarez photo packet", related: "P-311", owner: "Evan Cole", priority: "Low", status: "Done", age: "—" },
];
