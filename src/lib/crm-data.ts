...
export const leads: Lead[] = [
  ...
  { id: "L-4819", name: "Todd & Kim Hale", phone: "(480) 555-0198", email: "khale@cox.net", address: "7721 E Via de Ventura", city: "Scottsdale, AZ", source: "Google", status: "Ran", tone: "up", setter: "Amber Quinn", closer: "Dana Ortiz", office: "Scottsdale", created: "Sep 10", next: "Proposal out", product: "HVAC 4-ton + ducts", value: 28640, notes: "Existing 16-year Goodman. Interested in financing.", secondaryName: "Kim Hale", secondaryEmail: "kim.hale@cox.net", secondaryPhone: "(480) 555-0198", yearBuilt: "2004", stories: "2", utility: "APS", hoa: "Yes", access: "Condenser on the side yard.", bothHome: true, finance: "Finance", rebate: false, qualify: { "Q-1": "Yes", "Q-2": "Yes", "Q-3": "Homeowner", "Q-4": "Yes", "Q-5": "Finance" }, pain: "AC not cooling. West rooms 8–10° over the thermostat.", hotRooms: "West bedrooms", coldRooms: "Kitchen", formName: "Google HVAC form", formAnswers: [
    { q: "What do you need help with?", a: "AC not cooling. Looking at a replacement." },
    { q: "Year built?", a: "2004" },
    { q: "Best time for a sit?", a: "Evenings after 5" },
    { q: "How did you find us?", a: "Google" },
  ] },
  ...
  { id: "L-4808", name: "Sharon Nguyen", phone: "(623) 555-0177", email: "snguyen@yahoo.com", address: "14001 N Prasada Pkwy", city: "Surprise, AZ", source: "Website", status: "Unmarked", tone: "alert", setter: "Priya Shah", closer: "Marco Velez", office: "Phoenix", created: "Sep 8", next: "Needs disposition", product: "Insulation removal", value: 6400, notes: "Setter said run happened. No outcome logged.", formName: "Website attic form", formAnswers: [
    { q: "What's going on?", a: "Old insulation is dirty. Want it pulled and replaced." },
    { q: "Anyone home during the day?", a: "Yes, retired." },
    { q: "HOA?", a: "Yes, Prasada." },
    { q: "How did you find us?", a: "cozyhome.com" },
  ] },
  ...
  { id: "L-4774", name: "Nina Patel", phone: "(214) 555-0188", email: "nina.patel@gmail.com", address: "7220 Hillcrest Ave", city: "Dallas, TX", source: "Website", status: "Confirmed", tone: "navy", setter: "Amber Quinn", closer: "Luis Haddad", office: "Dallas", created: "Sep 2", next: "Sep 13 4:00p", product: "Air sealing", value: 7200, notes: "Confirmed twice. High no-show risk historically in that zip." },
...
export const appointments: Appointment[] = [
  ...
  { id: "AP-77", leadId: "L-4819", name: "Hale proposal review", day: 13, time: "5:00p", status: "Today", tone: "navy", setter: "Amber Quinn", closer: "Dana Ortiz", product: "HVAC 4-ton + ducts", city: "Scottsdale", kind: "Assessment", setBy: "Amber Quinn", duration: "1.5h", notes: "Assess the condenser and the hatch." },
