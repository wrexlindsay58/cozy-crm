...
const HATCHES = ["Hall closet", "Garage", "Laundry", "Bedroom closet", "Ceiling"];
...
const seed: AssessCategory[] = [
  {
    ...
    on: true,
    fields: [
      f("attic-0", "Hatch location", "pick", HATCHES),
      f("attic-1", "Hatch size (W x H)", "text"),
