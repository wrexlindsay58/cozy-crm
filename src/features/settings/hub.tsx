...
const GROUPS = [
  ...
  },
  {
    title: "Pipeline",
    links: [
      { to: "/settings/assessments", title: "Assessment categories", note: "What the assessment covers, and the fields on each" },
      { to: "/settings/production", title: "Production categories", note: "Plan, permit, serials, supplier, BOM" },
