...
import { acceptOption, applyGoodLeap, demoMonthly, lineAmount, optionTotal, requestDeposit, sendToSign, type OptCard, type OptLine, type Proposal } from "./store";
import { BRAND } from "./brand";
import { cn } from "@/lib/cn";

const TERM_LABEL: Record<number, string> = { 60: "5 yr", 120: "10 yr", 144: "12 yr", 180: "15 yr", 240: "20 yr" };

function picksOn(line: OptLine) {
...
function scopeLines(opt: OptCard) {
  return opt.lines
